...
J = (1/m) * sum(sum((-y_Vec.*log(h_x))-((1-y_Vec).*log(1-h_x)))) + reg_term;

% -------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% part 2 %%%%%%%%%%%%%%%%%%%%%

delta3 = a3 - y_Vec;
delta2 = (delta3 * Theta2) .* [ones(a2_size,1), sigmoidGradient(z2)];
delta2 = delta2(:,2:end);
...
Theta1_grad = (1/m) * (delta2' * a1) + Theta1_grad_reg_term;
Theta2_grad = (1/m) * (delta3' * a2) + Theta2_grad_reg_term;
